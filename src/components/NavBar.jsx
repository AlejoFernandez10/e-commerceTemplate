        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <Link to={'/cart'} className='flex'><img srcSet={CartLogo} alt="CartImg" /><span className=' pl-[5px] text-white text-[14px]'></span></Link> 
          ...
          <nav aria-label="Site Nav">
            <ul className="flex items-center gap-6 text-sm ul">
              <li className='navLink'>
                <Link to={'/'}
                  className="text-[16px] text-gray-800  hover:text-pink-600 "
