    ...
    <motion.div  animate={{scale:1}} initial={{scale:0}} transition={{duration:.7}}   className='w-[100%] h-[90vh] relative m-auto transition duration-300    group rounded-[15px] bg-gradient-to-r from-pink-50 to-pink-200' > 
      ...
      <div   className='w-full h-full  rounder-2xl   duration-500 flex flex-col items-center  sm:flex-row justify-center  md:w-[100%]'>
        ...
        <motion.div className=' h-[40%] flex flex-col  justify-end gap-3  md:w-[50%] md:m-auto  '>
          <div  className=' text-5xl mb-10 w-[100%] font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-pink-600 to-pink-300 sm:text-6xl md:text-7xl  md:text-center  lg:text-[80px]  ' ><span></span> {sliderItems[currentIndex].h2Content}</div>
          
          <div  className='self-center py-3 px-7  mb-10  border bg-pink-400 rounded-[8px] text-gray-50 scale-100 hover:scale-105 transition duration-200 md:self-center  ' > <Link to={'/catalogo'}>Comprar</Link></div>
        </motion.div>
